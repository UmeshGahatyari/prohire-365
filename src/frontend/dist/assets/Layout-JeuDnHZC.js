import { r as reactExports, j as jsxRuntimeExports, ae as React, aj as React$1, b as reactDomExports, ag as ReactDOM, u as useNavigate, ak as useRouterState } from "./index-ByYMEgVg.js";
import { d as clsx, f as composeRefs, a as useComposedRefs, c as createLucideIcon, S as Slot$1, b as cn, u as useAuth, B as Briefcase, U as User } from "./useAuth-OLjIzFBE.js";
...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold transition-all duration-200 disabled:pointer-events-none disabled:opacity-40 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:ring-2 focus-visible:ring-ring/60 focus-visible:ring-offset-2 focus-visible:ring-offset-background aria-invalid:ring-destructive/20 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground shadow-card hover:bg-primary/90 hover:shadow-portal active:scale-[0.98]",
        cta: "text-white shadow-card hover:opacity-90 hover:shadow-portal active:scale-[0.98] border-0",
        destructive: "bg-destructive text-destructive-foreground shadow-xs hover:bg-destructive/85 active:scale-[0.98]",
        outline: "border border-border bg-transparent shadow-xs hover:bg-primary/8 hover:border-primary/40 hover:text-primary active:scale-[0.98]",
        secondary: "bg-secondary text-secondary-foreground shadow-xs hover:bg-secondary/70 active:scale-[0.98]",
...
function Button({
  ...
  const gradientStyle = variant === "cta" ? {
    background: "linear-gradient(135deg, oklch(0.55 0.18 280) 0%, oklch(0.72 0.22 190) 100%)",
    ...style ?? {}
  } : variant === "glow" ? {
    background: "linear-gradient(135deg, oklch(0.55 0.18 280) 0%, oklch(0.72 0.22 190) 100%)",
    boxShadow: "0 4px 20px oklch(0.72 0.22 190 / 0.35), 0 2px 8px oklch(0 0 0 / 0.2)",
    ...style ?? {}
  } : style ?? {};
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Comp,
...
function Sidebar({ role }) {
  const nav = role === "employee" ? employeeSidebarNav : role === "employer" ? employerSidebarNav : adminSidebarNav;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "aside",
    {
      ...
      style: {
        background: "linear-gradient(180deg, oklch(0.13 0.01 260) 0%, oklch(0.10 0.008 255) 100%)",
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "radial-gradient(ellipse at 50% 0%, oklch(0.5 0.16 280 / 0.12) 0%, transparent 70%)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "nav",
          {
            ...
            children: nav.map((item) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                ...
                ${active ? "text-foreground shadow-card" : "text-muted-foreground hover:text-foreground"}`,
                  style: active ? {
                    background: "linear-gradient(135deg, oklch(0.5 0.16 280 / 0.25) 0%, oklch(0.72 0.22 190 / 0.12) 100%)",
                  ...
                  children: [
                    active && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        style: {
                          background: "linear-gradient(180deg, oklch(0.72 0.22 190), oklch(0.5 0.16 280))"
                        }
                      }
                    ),
                    !active && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      item.icon,
                      {
                        className: `h-4 w-4 shrink-0 transition-smooth ${active ? "text-accent" : "text-muted-foreground group-hover:text-primary"}`
                      }
                    ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "radial-gradient(ellipse at 50% 100%, oklch(0.72 0.22 190 / 0.06) 0%, transparent 70%)"
            }
          }
        )
      ]
...
function Layout({
  ...
  const dashboardHref = role === "employee" ? "/employee" : role === "employer" ? "/employer" : "/admin";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "header",
      {
        className: `sticky top-0 z-50 transition-smooth ${scrolled ? "shadow-portal" : "shadow-card"}`,
        style: {
          background: scrolled ? "oklch(0.12 0.008 255 / 0.92)" : "oklch(0.13 0.01 260 / 0.98)",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "linear-gradient(90deg, oklch(0.5 0.16 280) 0%, oklch(0.72 0.22 190) 50%, oklch(0.5 0.16 280) 100%)"
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-screen-xl mx-auto px-4 h-14 flex items-center gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "nav",
              {
                ...
                children: [
                  ...
                  (item) => item.isRoute ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
              ...
              isAuthenticated ? /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Button,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline max-w-[110px] truncate text-sm", children: name ?? "Account" }),
                  ...
                  DropdownMenuContent,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        DropdownMenuItem,
                        {
                          onClick: () => navigate({ to: dashboardHref }),
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuSeparator, { className: "bg-border/40" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        DropdownMenuItem,
                        {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative z-10", children: "Get Started" })
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  ...
                  children: mobileMenuOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-4 w-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Menu$1, { className: "h-4 w-4" })
                }
              )
            ] })
          ] }),
          mobileMenuOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: ["Find Jobs", "Companies", "Resources"].map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 min-h-0", children: [
      showSidebar && sidebarRole && /* @__PURE__ */ jsxRuntimeExports.jsx(Sidebar, { role: sidebarRole }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 min-w-0 overflow-auto", children })
    ] }),
    !showSidebar && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "footer",
      {
        className: "relative overflow-hidden",
        style: {
          background: "linear-gradient(180deg, oklch(0.10 0.008 255) 0%, oklch(0.08 0.01 250) 100%)",
          borderTop: "1px solid oklch(0.28 0.015 260 / 0.4)"
        },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "linear-gradient(90deg, transparent 0%, oklch(0.5 0.16 280 / 0.6) 30%, oklch(0.72 0.22 190 / 0.8) 50%, oklch(0.5 0.16 280 / 0.6) 70%, transparent 100%)"
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-screen-xl mx-auto px-4 py-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8 mb-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5 font-display font-bold text-lg mb-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Briefcase, { className: "h-3.5 w-3.5 text-white" })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground leading-relaxed max-w-xs", children: "The premium job platform connecting top talent with world-class companies." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-12 md:justify-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-foreground/60 uppercase tracking-wider mb-3", children: "Platform" }),
                ["Find Jobs", "For Employers", "Pricing"].map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-foreground/60 uppercase tracking-wider mb-3", children: "Legal" }),
                ["Privacy", "Terms", "Help"].map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    className: "text-xs text-muted-foreground hover:text-foreground cursor-pointer transition-smooth mb-1.5",
                    children: l
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:text-right", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground/60 mt-3", children: [
                "© ",
                (/* @__PURE__ */ new Date()).getFullYear(),
                " ProHire 365. All rights reserved."
              ] })
            ] })
          ] }) })
        ]
...
export {
  ...
  createContext2 as v,
  Root$1 as w,
  createRovingFocusGroupScope as x,
  cva as y
};
