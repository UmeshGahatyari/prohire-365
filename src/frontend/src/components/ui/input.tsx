    ...
    <input
      ...
      onFocus={(e) => {
        (e.currentTarget as HTMLInputElement).style.border =
          "1px solid oklch(0.72 0.22 190 / 0.6)";
        (e.currentTarget as HTMLInputElement).style.boxShadow =
          "0 0 0 3px oklch(0.72 0.22 190 / 0.12), 0 2px 8px oklch(0 0 0 / 0.2)";
        (e.currentTarget as HTMLInputElement).style.background =
          "oklch(0.19 0.014 260 / 0.9)";
      }}
      onBlur={(e) => {
        (e.currentTarget as HTMLInputElement).style.border =
          "1px solid oklch(0.30 0.015 260 / 0.6)";
        (e.currentTarget as HTMLInputElement).style.boxShadow = "";
        (e.currentTarget as HTMLInputElement).style.background =
          "oklch(0.18 0.012 258 / 0.8)";
      }}
      {...props}
    />
  );
